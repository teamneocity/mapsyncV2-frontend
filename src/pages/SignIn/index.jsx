  ...
  return (
    <div className="min-h-screen flex items-center justify-center font-manrope px-4 bg-[#EBEBEB]">
      <form
        ...
        className="w-full max-w-[400px] min-h-[30rem] flex flex-col items-center justify-center gap-8 bg-[#EBEBEB] p-6 rounded-2xl text-center overflow-hidden"
      >
        ...
        <div className="w-full max-w-[366px] flex gap-2">
          <Button type="submit" className="flex-1 h-[55px] rounded-[16px]">
            Login
          </Button>
