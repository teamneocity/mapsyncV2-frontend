...
export function ExpandedRowServiceOrder({ occurrence }) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-white p-4 rounded-lg shadow-sm text-sm">
      ...
      <div className="space-y-4 col-span-1">
        ...
        <div>
          ...
          <div className="bg-[#F8F8F8] rounded-xl px-4 py-2 min-h-[96px] text-gray-700">
      ...
      <div className="col-span-1 space-y-4">
        ...
        <Button className="w-full h-[72px] bg-green-100 hover:bg-green-200 text-green-700 mt-6">
          Finalizar
        </Button>
      </div>
