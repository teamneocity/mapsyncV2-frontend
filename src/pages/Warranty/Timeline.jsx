...
export function Timeline({ timeline }) {
  return (
    // cria um contexto de empilhamento local para evitar sobreposição
    <div className="relative mt-4 pl-6 isolate z-0">
      <ul className="space-y-6 relative z-0">
        {timeline.map((step, index) => {
          ...
          return (
            <li key={index} className="relative flex items-start gap-3">
              ...
              <div className="absolute -left-6 top-1 flex flex-col items-center z-[1] pointer-events-none">
